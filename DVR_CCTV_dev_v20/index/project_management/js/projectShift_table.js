...
//为了提高复用性，建议用append方式渲染<tr id="xxx">
// function autoFill(cam_id_value, idx) {
//
//     $.ajax({
...
//
//             $("#monRoom_"+idx).val(obj.monitoring_room);
//             $("#dvrID_"+idx).val(obj.dvR_ID);
//             $("#Channel_"+idx).val(obj.channel_ID);
//             $("#build_"+idx).val(obj.build);
//             $("#floor_"+idx).val(obj.floor);
//             $("#direct_"+idx).val(obj.direction);
//             $("#location_"+idx).val(obj.location);
//             $("#camType_"+idx).val(obj.camera_Tpye);
//             $("#dep_"+idx).val(obj.department);
//             $("#cost_"+idx).val(obj.cost_code);
//             $("#insTime_"+idx).val(obj.install_time);
//             $("#insManu_"+idx).val(obj.manufacturer);
//             $("#alaNum_"+idx).val(obj.alarm_ID);
//             $("#rem_"+idx).val(obj.remark);
//             $("#monTyp_"+idx).val(obj.monitorClassification);
//             $("#cat_"+idx).val(obj.category);
//
//         },
//         error: function () {
//             $.dialog({
