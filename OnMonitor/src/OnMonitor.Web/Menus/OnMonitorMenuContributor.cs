...
namespace OnMonitor.Web.Menus
{
    public class OnMonitorMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public OnMonitorMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.ServiceProvider.GetRequiredService<IStringLocalizer<OnMonitorResource>>();

            context.Menu.Items.Insert(0, new ApplicationMenuItem("OnMonitor.Home", l["Menu:Home"], "/"));
