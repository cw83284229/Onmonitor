...
{
    public class OnMonitorDbMigrationService : ITransientDependency
    {
        public ILogger<OnMonitorDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IOnMonitorDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public OnMonitorDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IOnMonitorDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<OnMonitorDbMigrationService>.Instance;
        }
