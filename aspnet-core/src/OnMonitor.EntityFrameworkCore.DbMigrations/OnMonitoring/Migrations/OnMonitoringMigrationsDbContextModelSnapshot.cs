...
namespace OnMonitoring.Migrations
{
    [DbContext(typeof(OnMonitorMigrationsDbContext))]
    partial class OnMonitoringMigrationsDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("OnMonitor.Monitor.DVRCheckInfo", b =>
                {
                    ...
                    b.Property<string>("LibraryChannelInfo")
                        .HasColumnType("nvarchar(max)");
